...
```bash
# All gates (pnpm)
pnpm run build                    # Gates 1+2: Syntax & Types (tsc --noEmit)
pnpm run lint                     # Gate 3: Code quality
pnpm test                         # Gate 5: Tests (vitest)
...
| `quality-gates/examples/javascript.md` | JS/TS gate commands                      |
